...
/*function handleSubmit (event) {
  ...
  // Get form values
  const startDate = document.getElementById('day-of-month').value
  ...
  if (!startDate || !startTime || !endTime || !maxConsultsDay || !maxConsultsStudents || !recurringOption) {
  ...
  $.ajax({
    ...
    data: JSON.stringify({ startDate, startTime, recurringOptionBinary, endDate, endTime, maxConsultsDay, maxConsultsStudents, description }), // data sent (converted to JSON)
